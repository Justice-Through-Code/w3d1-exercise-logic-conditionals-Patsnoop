...
def stock_purchases():
    ...
    client_money = int(input('How much would you like to invest?'))
    ...
    if stock_name == "Amazon":
        stock = client_money / amazon
    elif stock_name == "Apple":
        stock = client_money / apple
    elif stock_name == "Facebook":
        stock = client_money / fb
    elif stock_name == "Google":
        stock = client_money / google
    else:
        stock = client_money / msft
    stock = int(stock)
    ...
    print(f"{client_name} has ${client_money} to invest and can buy {stock} shares of {stock_name} at the current price of $100.")
# stock_purchases()